...
- Автоматические интервью с адаптивным сценарием: агенты (`general`, `technical`, `coding`, `emotion`, `report`) подбирают вопросы под профиль кандидата и анализируют ответы.
...
- Интеграция с Redis для кеширования и очередей, а также готовый Nginx API Gateway.
